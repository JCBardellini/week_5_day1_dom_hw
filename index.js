...
const mainEl = document.querySelector("main"); // selected the main element from the html doc
mainEl.style.backgroundColor = "var(--main-bg)";
// set background color to var --main-bg in css file
mainEl.innerHTML = "<h1>SEI Rocks!</h1>";
mainEl.classList.add("flex-ctr");

const topMainEl = document.querySelector("#top-menu"); // grab the top menu by ID
